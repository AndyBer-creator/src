// в данном коде возникает deadlock из-за того что индекс записи разделяемый ресурс.
// уменьшение значения индекса записи в буфер нужно перенести на горутину чтения
package main
